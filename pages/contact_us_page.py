...
class ContactUsPage(BasePage):
    ...
    _subject_heading = "uniform-id_contact"
    _email_address = "email"
    _order_reference = "id_order"
    _attach_file = "fileUpload"
    _message = "message"
    _send = "submitMessage"
    ...
    def _choose_subject_heading(self, select_val, ):
        self.select_from_drop_down(select_value=select_val,locator=self._subject_heading, locator_type='id',select_by='val')
    ...
    def _click_send(self):
        self.element_click(self._send, locator_type="link")

    def send_a_message_successful(self,sub_heading, email_address, order_ref, file_path,message):
    ...
    def get_success_message(self):
        return self.get_element_text(locator=self._success_message).text
